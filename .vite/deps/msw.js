...
var HttpHandler = class extends RequestHandler {
  ...
  async parse(args) {
    ...
    const match = this.info.path ? matchRequestUrl(url, this.info.path, (_a2 = args.resolutionContext) == null ? void 0 : _a2.baseUrl) : { matches: false, params: {} };
    return {
      match,
      cookies
    };
...
async function parseQuery(query) {
  const { parse: parse3 } = await import("./graphql-AU2Y2I4X.js").catch((error) => {
...
var _GraphQLHandler = class _GraphQLHandler extends RequestHandler {
  constructor(operationType, predicate, endpoint, resolver, options) {
    var _a2, _b2;
    const operationName = __privateMethod(_a2 = _GraphQLHandler, _GraphQLHandler_static, parseOperationName_fn).call(_a2, predicate, operationType);
...
var ServerSentEventHandler = class extends HttpHandler {
  ...
  async predicate(args) {
    ...
    if (matches && !((_a2 = args.resolutionContext) == null ? void 0 : _a2.quiet)) {
      await super.log({
        request: args.request,
        /**
...
sendMessage_fn = function(message2) {
  ...
  __privateGet(this, _emitter2).emit("message", {
    id: message2.id,
    event: ((_a2 = message2.event) == null ? void 0 : _a2.toString()) || "message",
    data: message2.data,
    frames
  });
};
...
var _ObservableEventSource = class _ObservableEventSource extends (_i = EventTarget, _h = kRequest, _g = kReconnectionTime, _f = kLastEventId, _e = kAbortController, _d = kOnOpen, _c = kOnMessage, _b = kOnAnyMessage, _a = kOnError, _i) {
  ...
  interpretResponseBody(response) {
    const parsingStream = new EventSourceParsingStream({
      message: (message2) => {
        ...
        (_a2 = this[kOnAnyMessage]) == null ? void 0 : _a2.call(this, messageEvent);
...
var EventSourceParsingStream = class extends WritableStream {
  constructor(underlyingSink) {
    super({
      ...
      abort: (reason) => {
        var _a2, _b2;
        (_b2 = (_a2 = this.underlyingSink).abort) == null ? void 0 : _b2.call(_a2, reason);
      },
      close: () => {
        var _a2, _b2;
        (_b2 = (_a2 = this.underlyingSink).close) == null ? void 0 : _b2.call(_a2);
      }
    });
...
async function handleRequest(request, requestId, handlers, options, emitter, handleRequestOptions) {
  ...
  if ((_a2 = request.headers.get("accept")) == null ? void 0 : _a2.includes("msw/passthrough")) {
