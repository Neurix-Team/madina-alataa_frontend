...
function shouldBypassRequest(request) {
  var _a15;
  return !!((_a15 = request.headers.get("accept")) == null ? void 0 : _a15.includes("msw/passthrough"));
}
  ...
  async resolve(handlers, onUnhandledFrame, resolutionContext) {
    ...
    const [lookupError, lookupResult] = await until(() => {
      ...
      return executeHandlers({
        ...
        handlers,
        resolutionContext: {
          baseUrl: (_a15 = resolutionContext == null ? void 0 : resolutionContext.baseUrl) == null ? void 0 : _a15.toString(),
...
function getVariable(variableName) {
  ...
  return (_a15 = globalThis[variableName]) == null ? void 0 : _a15.toString();
}
...
var Interceptor = class {
  ...
  */
  ...
  getInstance() {
    ...
    this.logger.info("retrieved global instance:", (_a15 = instance == null ? void 0 : instance.constructor) == null ? void 0 : _a15.name);
    return instance;
  }
  setInstance() {
  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a15;
      this.bufferedAmount = 0;
      (_a15 = this[kOnSend]) == null ? void 0 : _a15.call(this, data);
    });
  }
  close(code = 1e3, reason) {
    invariant2(code, WEBSOCKET_CLOSE_CODE_RANGE_ERROR);
    invariant2(code === 1e3 || code >= 3e3 && code <= 4999, WEBSOCKET_CLOSE_CODE_RANGE_ERROR);
...
var _RequestController2_instances, handled_get, _a4;
var RequestController = (_a4 = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _a4.PENDING;
  ...
  */
  async passthrough() {
    invariant2.as(InterceptorError, this.readyState === _a4.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _a4.PASSTHROUGH;
  ...
  */
  respondWith(response) {
    invariant2.as(InterceptorError, this.readyState === _a4.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _a4.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant2.as(InterceptorError, this.readyState === _a4.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason == null ? void 0 : reason.toString(), this.readyState);
    this.readyState = _a4.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = function() {
  return this.handled;
}, _a4.PENDING = 0, _a4.PASSTHROUGH = 1, _a4.RESPONSE = 2, _a4.ERROR = 3, _a4);
...
var _a5;
var FetchResponse = (_a5 = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _a5.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_a5.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _a5.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _a5.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
    ...
    _a5.setUrl(init.url, this);
  }
}, _a5.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _a5.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
var LensList = (_a6 = class {
  ...
  */
  delete(key, value) {
    ...
    for (const [existingKey, values] of __privateGet(this, _lens)) if (existingKey === key && values.includes(value)) values.splice(values.indexOf(value), 1);
  }
  /**
...
var _a7, _b, _c, _d, _returnType, _e;
var TypedEvent2 = (_e = class extends (_d = MessageEvent, _c = kDefaultPrevented2, _b = kPropagationStopped, _a7 = kImmediatePropagationStopped, _d) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
var _listeners, _Emitter2_instances, addListener_fn, proxyEvent_fn, callListener_fn, matchListeners_fn, isTypelessListener_fn, _a8;
var Emitter22 = (_a8 = class {
  ...
  */
  ...
  if ((_a15 = listener[kListenerOptions]) == null ? void 0 : _a15.once) {
    const key = __privateMethod(this, _Emitter2_instances, isTypelessListener_fn).call(this, listener) ? "*" : event.type;
    __privateGet(this, _listeners).delete(key, listener);
  }
  return returnValue;
  ...
  return __privateGet(this, _listeners).get("*").includes(listener);
}, _a8);
var SUPPORTS_SERVICE_WORKER = supportsServiceWorker();
var _workerEvent, _a9;
var WorkerEvent = (_a9 = class extends TypedEvent2 {
...
var _frames2, _channel, _clientPromise, _keepAliveInterval, _stoppedAt, _ServiceWorkerSource_instances, startWorker_fn, handleRequest_fn2, handleResponse_fn2, _defaultFindWorker, checkWorkerIntegrity_fn, printStartMessage_fn, printStopMessage_fn, _a10;
var ServiceWorkerSource = (_a10 = class extends NetworkSource {
  constructor(options) {
    super();
    __privateAdd(this, _ServiceWorkerSource_instances);
  ...
  async enable() {
    ...
    const [worker, registration] = await __privateMethod(this, _ServiceWorkerSource_instances, startWorker_fn).call(this);
    ...
    if (!this.options.quiet) {
      __privateMethod(this, _ServiceWorkerSource_instances, printStartMessage_fn).call(this);
    }
    return registration;
  }
  disable() {
    ...
    this.workerPromise = new DeferredPromise();
    if (!this.options.quiet) {
      __privateMethod(this, _ServiceWorkerSource_instances, printStopMessage_fn).call(this);
    }
  }
}, _frames2 = new WeakMap(), _channel = new WeakMap(), _clientPromise = new WeakMap(), _keepAliveInterval = new WeakMap(), _stoppedAt = new WeakMap(), _ServiceWorkerSource_instances = new WeakSet(), startWorker_fn = async function() {
  var _a15;
  ...
  const [worker, registration] = await getWorkerInstance(
    ...
    this.options.findWorker || __privateGet(this, _defaultFindWorker)
  );
  if (worker == null) {
    const missingWorkerMessage = ((_a15 = this.options) == null ? void 0 : _a15.findWorker) ? devUtils.formatMessage(
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
  ...
  __privateGet(this, _channel).on("REQUEST", __privateMethod(this, _ServiceWorkerSource_instances, handleRequest_fn2).bind(this));
  __privateGet(this, _channel).on("RESPONSE", __privateMethod(this, _ServiceWorkerSource_instances, handleResponse_fn2).bind(this));
  ...
  await __privateMethod(this, _ServiceWorkerSource_instances, checkWorkerIntegrity_fn).call(this).catch((error2) => {
    devUtils.error(
  ...
  if ((_a15 = response.type) == null ? void 0 : _a15.includes("opaque")) {
...
var _event, _ServiceWorkerHttpNetworkFrame_instances, respondWith_fn, _a11;
var ServiceWorkerHttpNetworkFrame = (_a11 = class extends HttpNetworkFrame {
  constructor(options) {
...
var _a12;
var FetchInterceptor = (_a12 = class extends Interceptor {
  constructor() {
    super(_a12.symbol);
  }
  checkEnvironment() {
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a15;
              (((_a15 = this.onRequest) == null ? void 0 : _a15.call(this, {
                request: fetchRequest,
                requestId: this.requestId
...
var _a13;
var XMLHttpRequestInterceptor = (_a13 = class extends Interceptor {
  constructor() {
    super(_a13.interceptorSymbol);
  }
  checkEnvironment() {
...
}, _a13.interceptorSymbol = Symbol("xhr"), _a13);
var _FallbackHttpSource_instances, printStartMessage_fn2, printStopMessage_fn2, _a14;
var FallbackHttpSource = (_a14 = class extends InterceptorSource {
  constructor(options) {
    super({
  ...
  return {
    async start(options) {
      ...
      const httpSource = supportsServiceWorker() ? new ServiceWorkerSource({
        serviceWorker: {
          url: ((_b2 = (_a15 = options == null ? void 0 : options.serviceWorker) == null ? void 0 : _a15.url) == null ? void 0 : _b2.toString()) || DEFAULT_WORKER_URL,
