        ...
        >
          ...
          <div className="flex items-center justify-between p-8 pb-0">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-white">إضافة مؤسسة</h2>
                <p className="text-blue-300/70 font-medium mt-1">إنشاء مؤسسة شريك جديدة</p>
              </div>
            </div>
            <motion.button
          ...
          <form onSubmit={handleSubmit} className="p-8 pt-6 space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl px-8 py-5 font-black text-lg flex items-center justify-center gap-3 border border-blue-400/30 shadow-xl shadow-blue-900/40 disabled:opacity-50 disabled:cursor-not-allowed transition-all mt-6"
            >
              {isSubmitting ? (
                <>
