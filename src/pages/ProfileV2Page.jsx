...
const styles = {
  ...
  logo: { fontSize: 16, fontWeight: 900, color: 'var(--text-primary)', marginTop: 4 },
  subtitle: { fontSize: 10, letterSpacing: 2, color: 'var(--primary)', fontWeight: 700, textTransform: 'uppercase' },
  miniProfile: {
    borderRadius: 18,
  ...
  miniName: { fontSize: 15, fontWeight: 800, marginBottom: 2, color: 'var(--text-primary)' },
  miniLink: { fontSize: 11, color: 'var(--text-secondary)', fontWeight: 600, marginBottom: 8 },
  navBtn: {
    width: '100%',
